<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YoneticiGiris.aspx.cs" Inherits="Prolab2_3_3.YoneticiGiris" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:TextBox runat="server" ID="txtUsername" CssClass="inputField" placeholder="Yönetici Id" />
