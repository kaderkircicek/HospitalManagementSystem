<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YoneticiDoktorGuncelleme.aspx.cs" Inherits="Prolab2_3_3.YoneticiDoktorGuncelleme" %>
...
<body>
    <form id="form1" runat="server" class="form-container">
        <h3>Doktor Güncelleme Formu</h3>
        <div class="form-group">
            <label for="TextDoktorId">Doktor Id</label>
