<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HastaGiris.aspx.cs" Inherits="Prolab2_3_3.HastaGiris" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <h2>HASTA GİRİŞİ</h2>
           <asp:TextBox runat="server" ID="txtUsername" CssClass="inputField" placeholder="Hasta Id" />
