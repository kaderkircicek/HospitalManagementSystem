<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HastaRandevuGuncelle.aspx.cs" Inherits="Prolab2_3_3.HastaRandevuGuncelle" %>
...
<head runat="server">
    ...
    <title>Randevu Güncelleme İşlemi</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <h2> Randevu Güncelleme İşlemi</h2>
